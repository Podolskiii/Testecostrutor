...
public class vetores2exercicio {
...
////     Double[] semanaTres = new Double[]{ 1700.0, 1300.0, 1450.0, 2000.0, 1390.0, 800.0, 0.0 };
//   Double[] semanaQuatro = new Double[]{ 2100.0, 1600.0, 1850.0, 2100.0, 1220.0, 998.0, 0.0 };
//  ouble[][] mes = new Double[][] { semanaUm, semanaDois, semanaTres, semanaQuatro };
...
////  Crie um algoritmo que encontre qual a semana teve o maior faturamento. No fiDnal mostre qual foi essa semana e de quanto
